...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Fev-2023 às 04:04
...
(31, 'Marcelo Neri da Silva', 'marceloneri2@gmail.com', 'A', 2, 'sdsdsa', 'asdsa', 'asdsad', 'ASDS', '88085260', 'ASDSAD', 'Florianópolis', 'as', 'asdsad', 'ASDSA', 'marceloneri2@gmail.com', 'CZI2KQlb', 'asdsa', '../../images/users/avatar.png', '');
...
--
ALTER TABLE `conteudo`
  MODIFY `id_conteudo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;

--
-- AUTO_INCREMENT for table `conteudo_indice`
--
ALTER TABLE `conteudo_indice`
  MODIFY `id_conteudo_indice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
...
--
ALTER TABLE `trilha`
  MODIFY `trilha_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `trilha_videos`
  MODIFY `trilha_videos_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
...
--
ALTER TABLE `user_trilha`
  MODIFY `usertrilha_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
